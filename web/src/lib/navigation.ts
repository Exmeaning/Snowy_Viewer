...
export const searchableNavItems: SearchableNavItem[] = [
    ...
    { href: "/profile-card", group: "tools", keywords: ["profile card", "custom profile", "card workshop", "meishi"] },
...
export const NAV_ITEM_LABEL_KEYS: Record<string, string> = {
    ...
    "/profile-card": "layout.nav.items.profileCard",
...
export const NAV_ITEM_DESCRIPTION_KEYS: Record<string, string> = {
    ...
    "/profile-card": "layout.groupPages.profileCard",
