...
export const enUSMessages = {
    ...
    layout: {
        nav: {
            ...
            items: {
                ...
                profileCard: "Profile Card Workshop",
        ...
        groupPages: {
            ...
            profileCard: "Render and export custom profile cards in the browser via UID",
    ...
    page: {
        ...
        profileCard: {
            badge: "TOOLS · PROFILE CARD",
            title: "Profile Card",
            titleHighlight: "Workshop",
            description: "Enter an EN / TW / KR / CN UID to faithfully render Project SEKAI custom profile cards in the browser and export a native 1830×812 PNG.",
            form: {
                title: "Load a card by UID",
                description: "Pick a server and enter your in-game UID; the public custom profile data loads after passing the Cloudflare challenge.",
                uidPlaceholder: "Enter your in-game UID",
                server: "Server",
                submit: "Load card",
                loading: "Loading…",
            },
            fonts: {
                title: "Font files",
                description: "Due to font licensing, please provide the game's font files (.ttf / .otf) yourself. Matching file names map to their logical font families automatically.",
                add: "Add fonts",
            },
            turnstile: {
                ...
                scriptFailed: "Failed to load the verification script",
            },
            errors: {
                invalidUid: "Please enter a valid numeric UID",
                fontRequired: "Please add at least one font file",
                turnstileRequired: "Please complete the human verification first",
                noCards: "This account has no public custom profile card data",
            },
            status: {
                starting: "Starting renderer…",
                masterdata: "Loading game data…",
                scene: "Resolving card scene…",
            },
            workshop: {
                pageTab: "Page {index}",
                play: "Play",
            ...
            attribution: {
                prefix: "Rendering powered by the open-source project",
            },
        },
        mysekaiPreview: {
            metadata: {
