...
export interface StoryTypeInfo {
    ...
    descKey: string;
    /**
     * Flat category fill for the icon plate — a single `bg-*` utility, not a
     * gradient pair. The hue stays because it is the semantic marker that tells
     * the six story categories apart at a glance; only the two-stop ramp is
     * gone, because a gradient reads as depth on a surface that is meant to be
     * flat.
     */
    color: string;
    icon: ReactNode;
