        ...
        <div className="container mx-auto px-4 sm:px-6 py-8">
            ...
            <div className="flex flex-col lg:flex-row gap-6">
                ...
                <div className="flex-1 min-w-0">
                    <EventGrid events={data.displayedEvents} isLoading={data.isLoading} eventUnitMap={data.eventUnitMap} eventBannerCharMap={data.eventBannerCharMap} eventStoryIds={data.eventStoryIds} />
