...
const ALLOWLIST = new Map([
    ...
    ["src/lib/seo-keywords.ts", "SEO Chinese keyword strategy"],
    ["src/app/layout.tsx", "Root metadata and brand SEO Chinese copy"],
    ...
    ["src/app/design-system/page.tsx", "Development-only design-system demo route"],
